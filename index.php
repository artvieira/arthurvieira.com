	...
	<div style="width:800px; margin:0 auto;">
        <div style="width:268px;float:left;">
			...
			<div id="logo" style="height:196px; width:268px; text-align:center;">
				<span id="bt-es" class="multi-lang" style="margin-top:10px; margin-left:5px; margin-right:9px; background-color:#666; opacity:0.2; color:white; font-size:1.7em; display:block;">Spanish</span>
				<span id="bt-ptbr" class="multi-lang" style="margin-top:10px; margin-left:5px; margin-right:9px; background-color:#666; opacity:0.2; color:white; font-size:1.7em; display:block;">Portuguese</span>
				<span id="bt-en" class="multi-lang" style="margin-top:10px; margin-left:5px; margin-right:9px; background-color:#666; opacity:0.2; color:white; font-size:1.7em; display:block;">English</span>
